...
//import org.codehaus.groovy.grails.web.binding.DatabindingApi //TODO
        ...
        for (Map.Entry<String, Object> entry : data.entrySet()) {
            if (entry.key != 'class' && entry.key != 'id') {
                try {
                    ...
                    DataBindingUtils.bindObjectToInstance(instance,  Collections.singletonMap(entry.key, propertyValue));
                } catch(MappingException e) {
